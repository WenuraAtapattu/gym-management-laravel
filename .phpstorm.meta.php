...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.mongodb.options.tls' => 'boolean',
            'database.connections.mongodb.options.tlsInsecure' => 'boolean',
            ...
            'database.connections.mongodb.driver_options.context' => 'resource',
...
'database.connections.mariadb.host','database.connections.mariadb.database','database.connections.mariadb.username','database.connections.mariadb.password','database.connections.mariadb.unix_socket',
...
'database.connections.mariadb.engine','database.connections.pgsql.driver','database.connections.pgsql.url','database.connections.pgsql.host','database.connections.pgsql.port',
...
'database.connections.mongodb.port','database.connections.mongodb.database','database.connections.mongodb.username','database.connections.mongodb.password','database.connections.mongodb.dsn',
'database.connections.mongodb.options.database','database.connections.mongodb.options.tls','database.connections.mongodb.options.tlsInsecure','database.connections.mongodb.options.retryWrites','database.connections.mongodb.options.w',
'database.connections.mongodb.options.readConcern.level','database.connections.mongodb.options.readPreference','database.connections.mongodb.options.maxPoolSize','database.connections.mongodb.options.minPoolSize','database.connections.mongodb.options.maxIdleTimeMS',
'database.connections.mongodb.options.serverSelectionTimeoutMS','database.connections.mongodb.options.connectTimeoutMS','database.connections.mongodb.options.socketTimeoutMS','database.connections.mongodb.driver_options.context','database.migrations.table',
...
'livewire.update','livewire.upload-file','livewire.preview-file','products.reviews.index','products.reviews.show','users.index',
'users.store','users.show','users.update','users.destroy','products.index',
'products.store','products.show','products.update','products.destroy','products.reviews.store',
'products.reviews.update','products.reviews.destroy','payments.index',
'payments.store','payments.show','payments.update','payments.destroy','products.reviews.index','products.reviews.store',
'products.reviews.show','products.reviews.update','products.reviews.destroy','reviews.report','admin.reviews.pending',
'admin.reviews.approve','admin.reviews.reject','admin.reviews.stats','products.reviews.stats',
'home','about','contact','terms','privacy',
'products.index','products.featured','products.show','mongo.test','login-options',
'admin.login','admin.login.submit','dashboard','orders.index','orders.show',
'orders.store','orders.update-status','payments','profile.index','profile.update',
'cart.index','cart.store','cart.update','cart.destroy','cart.clear',
'checkout.index','checkout.store','members.index','admin.dashboard','admin.orders.index',
'admin.orders.show','admin.orders.status','admin.products.index','admin.products.create','admin.products.store',
'admin.products.edit','admin.products.update','admin.products.destroy','admin.users.index','admin.users.edit',
'admin.users.update','admin.users.destroy','storage.local',);
...
'layouts.original','livewire.admin.reviews.index','livewire.member-management','livewire.order-manager','livewire.payment-manager',
'livewire.product-filter','livewire.review-form','navigation-menu','orders.index','orders.show',
'pages.about','pages.contact','pages.privacy','pages.terms','policy',
'products.featured','products.index','products.search','products.show','profile.delete-user-form',
...
'terms','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button',
